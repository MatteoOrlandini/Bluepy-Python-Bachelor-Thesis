...
if __name__ == '__main__':
	...
	nome_file_valori_sensori = "/home/matteo/Scrivania/Dati sensori " + tempo + ".txt"
	nome_file_sensor_fusion_matlab = "/home/matteo/Scrivania/MATLAB/Sensor Fusion MATLAB " + tempo + ".txt"
	nome_file_accelerometro_matlab = "/home/matteo/Scrivania/MATLAB/Accelerometro MATLAB " + tempo + ".txt"
	nome_file_giroscopio_matlab = "/home/matteo/Scrivania/MATLAB/Giroscopio MATLAB " + tempo + ".txt"
	nome_file_magnetometro_matlab = "/home/matteo/Scrivania/MATLAB/Magnetometro MATLAB " + tempo + ".txt"
	...
	with open(nome_file_valori_sensori, 'a+') as file_valori_sensori:
		...
		try:
			...
			if (scelta_temperatura_pressione  == "s" or scelta_acc_giro_magn == "s" or scelta_sensor_fusion_compact == "s"):						
